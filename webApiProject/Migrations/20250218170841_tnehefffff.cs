...
{
    /// <inheritdoc />
    public partial class tnehefffff : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LanguePrefere = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PreferencesCommunication = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModePaiementPrefere = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HistoriqueConnexionsActions = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
